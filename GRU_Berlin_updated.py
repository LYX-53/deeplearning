...
#本代码参考网上已有的代码https://blog.csdn.net/weixin_55982578/article/details/136445476，并结合实际内容修改了input_dim为22，适应读取的数据集为Berlin_updated.csv中有22个变量，输出结果气温预测图部分内容代码
timestep = 1  # 时间步长，就是利用多少时间窗口
batch_size = 16  # 批次大小
#修改
input_dim = 22  # 每个步长对应的特征数量，就是使用每天的4个特征，最高、最低、开盘、落盘
hidden_dim = 64  # 隐层大小
