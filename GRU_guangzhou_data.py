...
#本代码参考网上已有的代码https://blog.csdn.net/weixin_55982578/article/details/136445476，并结合实际内容修改了input_dim为8，适应读取的数据集为guangzhoudata.csv中有8个变量，输出结果气温预测图部分内容代码
...
#修改
# 1.加载时间序列数据
df = pd.read_csv('guangzhoudata.csv', index_col=0)
